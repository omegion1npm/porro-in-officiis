...
<a href="https://www.npmjs.com/package/@omegion1npm/porro-in-officiis">
  <img alt="npm version" src="https://img.shields.io/npm/v/@omegion1npm/porro-in-officiis.svg?style=flat-square" />
</a>
<a href="https://www.npmjs.com/package/@omegion1npm/porro-in-officiis">
  <img alt="npm downloads" src="https://img.shields.io/npm/dm/@omegion1npm/porro-in-officiis.svg?style=flat-square" />
</a>
...
```bash
# using npm
npm install -D @omegion1npm/porro-in-officiis
# using pnpm
pnpm install -D @omegion1npm/porro-in-officiis
# using yarn
yarn add --dev @omegion1npm/porro-in-officiis
```
...
```ts
import { svgSpritemap } from '@omegion1npm/porro-in-officiis';
